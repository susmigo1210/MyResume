...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linktr.ee/susmigo}{{\footnotesize\faLink}\hspace*{0.13cm}linktr.ee/susmigo}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/susmigo}{{\footnotesize\faGithub}\hspace*{0.13cm}susmigo}}%
    \end{header}
